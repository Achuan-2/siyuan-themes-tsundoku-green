...
function sidebarHoverButtonImplementEven() {
    loadStyle('/appearance/themes/Tsundoku Green/style/topbar.css', 'topbarCss');
...
function createHighlightBecomesHidden() {
    loadStyle('/appearance/themes/Tsundoku Green/style/mark-display.css', 'markCss');
...
window.theme.loadScript('/appearance/themes/Tsundoku Green/script/module/window.js');
window.theme.loadScript('/appearance/themes/Tsundoku Green/script/module/doc.js');
window.theme.loadScript(
